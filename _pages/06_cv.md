...
### Articles
`2016` "Identifying and estimating neighborhood effects," accepted by the _Journal of Economic Literature_.

“An econometric model of link formation with degree heterogeneity," conditionally accepted by _Econometrica_.
...
`2016` "Identification and efficiency bounds for the average match function under conditionally exogenous matching,” (with Guido W. Imbens and Geert Ridder).

“Homophily and transitivity in dynamic network formation,” revision requested by the _Review of Economic Studies_.

`2015` “A quantile correlated random coefficients panel data model,” resubmitted to the _Journal of Econometrics_ (with Jinyong Hahn, Alex Poirier and Jim Powell).
...
## Short courses
`2016` “Econometric Methods for Networks,” Center for Operations Research and Econometrics, Belgium  
