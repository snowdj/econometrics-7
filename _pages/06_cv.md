...
### Articles
`2016` [A+] "Identifying and estimating neighborhood effects," accepted by the _Journal of Economic Literature_.

[A+] “An econometric model of link formation with degree heterogeneity," conditionally accepted by _Econometrica_.

[AP+] “Efficient estimation of data combination models by the method of auxiliary-to-study tilting (AST),” _Journal of Business and Economic Statistics_ 34 (2): 288 - 301 (with Cristine Pinto and Daniel Egel).

`2015` [P+] “Methods of identification in social networks,” _Annual Review of Economics_ 7 (1): 465 - 485.
...
`2016` [N] "Identification and efficiency bounds for the average match function under conditionally exogenous matching,” (with Guido W. Imbens and Geert Ridder).

“Homophily and transitivity in dynamic network formation”.

`2015` [R&R] “A quantile correlated random coefficients panel data model,” (with Jinyong Hahn, Alex Poirier and Jim Powell).
...
### Work in progress
`2016` [N] "The analysis of networks" (survey in preparation for the next volume of the _Handbook of Econometrics_).  

[N] _The Econometrics of Social and Economic Networks_ (edited book under contract with Elsevier, joint with Aureo de Paula).  

[N] "Closing the teacher quality gap: an empirical analysis of a teacher assignment problem," (with Geert Ridder, Petra Thiemann and Gema Zamarro).
