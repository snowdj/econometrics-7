...
`2019` “Kernel density estimation for undirected dyadic data,” (with Fengshi Niu and James L. Powell).   
 
“Network data,” to appear in the _Handbook of Econometrics_ 7A.    

“Testing for externalities in network formation using simulation,” to appear in _The Econometrics of Social and Economic Networks_ (with Andrin Pelican).  

“Dyadic regression,” to appear in _The Econometrics of Social and Economic Networks_.              

`2018` “Semiparametrically efficient estimation of the average linear regression function,” conditionally accepted by the _Journal of Econometrics_ (with Cristine Pinto).    
...
Co-Organizer, Gary Chamberlain Retirement Conference    
